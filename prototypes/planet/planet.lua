...
local planet_map_gen = require("__flesh-planet__/prototypes/planet/planet_map_gen")
...
PlanetsLib:extend({
    {
        ...
        icon_size = 64,
        starmap_icon = "__flesh-planet__/graphics/planet/starmap-planet-sarkis.png",
        starmap_icon_size = 500,
        map_gen_settings = planet_map_gen.sarkis(),
        gravity_pull = 10,
        draw_orbit = true,
        magnitude = 1.6,
        order = "z[sarkis]",
...
PlanetsLib.borrow_music(data.raw["planet"]["vulcanus"], data.raw["planet"]["sarkis"])